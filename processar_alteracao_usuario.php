...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()){
        echo "<script>alert('Usuario atualizar com sucesso!');window.location.href='buscar_usuario'</script>";
    }else{
        echo "<script>alert('Erro ao atualizar usuario!');window.location.href='buscar_usuario' </script>";
    }
}
